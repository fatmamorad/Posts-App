  ...
  toast.error(err?.response?.data?.error || "Something went wrong")
   ...
   return (
        ...
        <div className='flex flex-wrap justify-center items-center dark:text-white '>
            ...
            <div className='flex justify-centeritems-center h-screen  w-full md:w-auto  '> 
                <form onSubmit={handleSubmit((data)=>mutate(data))} className="md:w-96 w-1/2  mx-auto flex justify-center items-center flex-col">
