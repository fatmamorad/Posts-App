   ...
   return (
        ...
        <div className='flex flex-wrap flex-col justify-center items-center'>
            ...
            <div className='flex justify-centeritems-center h-screen  '> 
                ...
                })} className=" md:w-96 sm:w-1/2  mx-auto flex justify-center items-center flex-col">
                ...
                <div className="relative z-0 w-full mb-5 group">
                  ...
                  <p className='mb-3 dark:text-white'>Dont Have an Account ? <Link to='/Login' className='text-blue-600' >Register...</Link></p>
